"""Scrape Extra listings from Barnstormers.com and render them into
...
PAGE_TITLE = "Other Extra Ads on the Web"
...
EXTERNAL_SEARCH_LINKS = [
    ("Trade-A-Plane", "https://www.trade-a-plane.com/filtered/search?s-type=aircraft&s-keyword-search=extra&s-original-search=extra"),
    ("Controller", "https://www.controller.com/listings?keywords=extra"),
    ("ASO", "https://aso.com/search?q=Extra"),
]
...
<body>
  ...
  <div class="more-resources">
    <h2>Search More Extra Listings</h2>
    <p>View additional Extra Aircraft listings at these fine sites:</p>
